...
(function() {
  var async, descend, ensure, mapArray, mapData, mapObject, merge, sync,
    __slice = [].slice;
  ...
  sync.mapObject = function(object, mapFun) {
    var key, newObj, value;
    newObj = {};
    for (key in object) {
      value = object[key];
      newObj[key] = mapFun(key, value);
    }
    return newObj;
  };
  ...
  merge = function() {
    var each, key, newObj, objects, value, _i, _len;
